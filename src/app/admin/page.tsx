    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        <div className="space-y-2">
          ...
          <p className="text-gray-600">Track sales, product performance, and customer engagement in one place.</p>
          {dashboardLoading ? (
            <p className="text-xs text-gray-500">Syncing analytics from the database...</p>
          ) : null}
          <div className="flex flex-wrap gap-2 pt-2">
            <a href="#summary" className="px-3 py-1 rounded-full bg-white border text-sm text-gray-700">Summary</a>
            <a href="#workflows" className="px-3 py-1 rounded-full bg-white border text-sm text-gray-700">Quick actions</a>
            <a href="#sales" className="px-3 py-1 rounded-full bg-white border text-sm text-gray-700">Sales</a>
            <a href="#visuals" className="px-3 py-1 rounded-full bg-white border text-sm text-gray-700">Charts</a>
            <a href="#snapshot" className="px-3 py-1 rounded-full bg-white border text-sm text-gray-700">Snapshot</a>
            <a href="#performance" className="px-3 py-1 rounded-full bg-white border text-sm text-gray-700">Performance</a>
            <a href="#engagement" className="px-3 py-1 rounded-full bg-white border text-sm text-gray-700">Engagement</a>
          </div>
        </div>

        
        <section id="summary" className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Today's summary</h2>
              <p className="text-gray-600 text-sm">Fast overview of sales health and traffic.</p>
            </div>
            <Link href="/admin/orders" className="text-sm text-primary-700 hover:text-primary-800">Open orders</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            <MetricTile label="Orders" value={orderTotals.orders} />
            <MetricTile label="Paid" value={orderTotals.paidOrders} />
            <MetricTile label="Revenue (INR)" value={Math.round(orderTotals.revenueCents / 100).toLocaleString('en-IN')} />
            <MetricTile label="Views" value={analyticsTotals.view} />
            <MetricTile label="Clicks" value={analyticsTotals.click} />
            <MetricTile label="Inquiries" value={analyticsTotals.inquiry} />
          </div>
        </section>
        ...
        <section id="visuals" className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500">Charts</p>
        ...
        <section id="performance" className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-wide text-gray-500"></p>
