            ...
            <div className="card">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                {user.role?.toLowerCase() === 'admin' && (
                  <Link
                    href="/admin"
                    className="flex items-start gap-3 rounded-lg border border-primary-100 bg-primary-50 p-3 text-left transition-colors hover:bg-primary-100"
                  >
                    <ShieldCheck className="h-5 w-5 text-primary-700" />
                    <div>
                      <div className="text-sm font-semibold text-gray-900">Admin Dashboard</div>
                      <p className="text-xs text-gray-600">Manage catalog, orders, analytics, and reviews.</p>
                    </div>
                  </Link>
                )}
                <Link
