            ...
            <div className="card space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-lg border border-emerald-200 bg-white px-4 py-2 text-sm font-semibold text-emerald-700 shadow-sm transition-colors hover:bg-emerald-50"
                >
                  Send Email
                </a>
              </div>
          ...
          <div className="card p-4">
            ...
            <div className="mt-4 aspect-[4/3] w-full overflow-hidden rounded-xl border border-gray-200 bg-gray-100">
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6186.519934790049!2d72.85601137720002!3d19.262752121890717!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b0f9222f6dbd%3A0x93af3837c7e74dc4!2sSaraswati%20Complex%2C%20Sudhindra%20Nagar%2C%20Dahisar%20East%2C%20Mumbai%2C%20Maharashtra%20400068!5e1!3m2!1sen!2sin!4v1769954785179!5m2!1sen!2sin"
